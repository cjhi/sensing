...
3.3V_TEENSY
Text GLabel 10850 19900 3    39   Input ~ 0
3.3V_TEENSY
NoConn ~ 18300 12200
Wire Wire Line
...
U 1 1 6060F62B
P 10850 19750
F 0 "#FLG0101" H 10850 19825 50  0001 C CNN
F 1 "PWR_FLAG" H 10850 19923 50  0000 C CNN
F 2 "" H 10850 19750 50  0001 C CNN
F 3 "~" H 10850 19750 50  0001 C CNN
	1    10850 19750
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 605F8732
P 10900 21300
F 0 "J?" H 10950 21617 50  0000 C CNN
F 1 "Conn_02x03_Odd_Even" H 10950 21526 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_2x04_P2.54mm_Vertical" H 10900 21300 50  0001 C CNN
F 3 "~" H 10900 21300 50  0001 C CNN
	1    10900 21300
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 605FA4DA
P 9800 21200
F 0 "#PWR?" H 9800 20950 50  0001 C CNN
F 1 "GND" H 9805 21027 50  0000 C CNN
F 2 "" H 9800 21200 50  0001 C CNN
F 3 "" H 9800 21200 50  0001 C CNN
	1    9800 21200
	1    0    0    -1  
$EndComp
Wire Wire Line
	10700 21200 9800 21200
Text GLabel 14100 21050 3    50   Input ~ 0
BMS_to_Teensy
Text GLabel 10700 21300 0    50   Input ~ 0
3.3VBMS
Text GLabel 13900 18450 1    50   Input ~ 0
3.3VBMS
Text GLabel 13800 18450 1    50   Input ~ 0
3.3VBMS_Backup
Text GLabel 10700 21400 0    50   Input ~ 0
3.3VBMS_Backup
$Comp
L bno055:+3.3V #PWR?
U 1 1 606115A7
P 10850 19600
F 0 "#PWR?" H 10850 19450 50  0001 C CNN
F 1 "+3.3V" H 10865 19773 50  0000 C CNN
F 2 "" H 10850 19600 50  0001 C CNN
F 3 "" H 10850 19600 50  0001 C CNN
	1    10850 19600
	1    0    0    -1  
$EndComp
Wire Wire Line
	10850 19900 10850 19750
Wire Wire Line
...
DROGUE_DEPLOY
$Comp
L rev2:PKB24SPCH3601-B0 LS?
U 1 1 6063964C
P 23550 20100
F 0 "LS?" H 23654 20191 50  0000 L CNN
...
U 1 1 6063B873
P 23550 20650
F 0 "#PWR?" H 23550 20400 50  0001 C CNN
