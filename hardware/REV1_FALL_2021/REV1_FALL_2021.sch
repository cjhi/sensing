...
E-MATCH_TRIGGER_2
Text Notes 19500 7000 0    50   ~ 0
E-Match in series here
Text Label 20500 6600 0    50   ~ 0
V_EMATCH
Wire Wire Line
	20500 6950 20500 6600
Wire Wire Line
	21000 6950 20500 6950
Wire Wire Line
	20500 7050 21000 7050
$Comp
L power:GND #PWR0108
U 1 1 619F16BC
P 20500 8750
F 0 "#PWR0108" H 20500 8500 50  0001 C CNN
F 1 "GND" H 20505 8577 50  0000 C CNN
...
$EndComp
Wire Wire Line
	20500 7700 20500 7050
Wire Wire Line
	20500 8750 20500 8100
$Comp
L Connector:Screw_Terminal_01x02 J102
U 1 1 619F16C4
P 21200 6950
F 0 "J102" H 21280 6942 50  0000 L CNN
F 1 "Screw_Terminal_01x02" H 21280 6851 50  0000 L CNN
F 2 "TerminalBlock:TerminalBlock_bornier-2_P5.08mm" H 21200 6950 50  0001 C CNN
F 3 "~" H 21200 6950 50  0001 C CNN
	1    21200 6950
	1    0    0    -1  
$EndComp
Wire Wire Line
	19700 7900 20200 7900
Wire Wire Line
	18750 7900 19400 7900
$Comp
L Device:R R109
U 1 1 619F16CC
P 19550 7900
F 0 "R109" V 19343 7900 50  0000 C CNN
F 1 "R_10k" V 19434 7900 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.20x1.40mm_HandSolder" V 19480 7900 50  0001 C CNN
...
U 1 1 619F16D2
P 20400 7900
F 0 "Q102" H 20604 7946 50  0000 L CNN
F 1 "Q_NMOS_GDS" H 20604 7855 50  0000 L CNN
F 2 "footprints:TO-220-3" H 20600 8000 50  0001 C CNN
F 3 "~" H 20400 7900 50  0001 C CNN
	1    20400 7900
	1    0    0    -1  
$EndComp
$EndSCHEMATC
